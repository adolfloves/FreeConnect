...
Настройки → **«Обход Telegram»** → **«Настроить автоматически»**. Telegram откроется и
...
Настройки → «Обход Telegram» → **«Проверить обход»**. Проверка разберёт соединение по ступеням
